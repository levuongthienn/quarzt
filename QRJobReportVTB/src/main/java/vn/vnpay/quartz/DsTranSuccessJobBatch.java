 ...
 * @author khanhbn
 */
public class DsTranSuccessJobBatch implements Job {
    private final static Logger LOGGER = LogManager.getLogger(DsTranSuccessJobBatch.class);
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException {
        ...
        boolean out = DsReportDao.getInstance().JobDsTranSuccess();
        if (out) {
